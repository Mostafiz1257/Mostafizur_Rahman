...
<br /> <br />
      ...
      <div className=' w-1/2 '>
        <img className='h-[400px] mx-auto ' src="https://i.ibb.co/t4fdQ33/mostafiz.jpg" alt="Profile Picture" />
      </div>
    </div>
    </>
  );
